...
from deconvolution import svd_deconvolve, svd_deconvolve_with_OI
...
if __name__ == '__main__':
    ...
    son_est = svd_deconvolve_with_OI(obs, ir, oi_threshold=0.1)[:sonlen]
    ir_est = svd_deconvolve_with_OI(obs, son, oi_threshold=0.1)[:irlen]
    # calc error
