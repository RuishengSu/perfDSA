...
def train_net(net,
    ...
    # optimizer = optim.SGD(net.parameters(), lr=learning_rate, weight_decay=1e-8, momentum=0.99, nesterov=True)
...
if __name__ == '__main__':
    ...
    ckpt = os.path.join("./results", experiment.name, 'checkpoint.pt')
    ...
    df_result.to_csv(os.path.join("./results", experiment.name, 'summary.csv'),
